...
public class NoticeDao {
	 ...
	 * 后台系统，添加公告。
	 */
	public void addNotice(@NotNull Notice n) throws SQLException {
	 ...
	 * 后台系统，根据id查找公告。
	 */
	public Notice findNoticeById(@NotNull String n_id) throws SQLException {
	 ...
	 * 后台系统，根据id修改单个公告。
	 */
	public void updateNotice(@NotNull Notice n) throws SQLException {
